...
const WebUrlComponent = ({ shareIntent }: { shareIntent: ShareIntentType }) => {
  return (
    ...
    <View style={{ flexShrink: 1, padding: 5 }}>
        <LinkPreview text={"https://www.google.com/" }
        onPreviewDataFetched={(preview) => {
        console.log("Preview Data Fetched", preview)
        }}
        renderMinimizedImage={(preview) => {
          console.log("renderMinimizedImage", preview)
          return undefined
          }}
        />  
      </View>    
...
export default function ShareIntent() {
  ...
  console.log("!!!!!!!!!", shareIntent, hasShareIntent, error);
